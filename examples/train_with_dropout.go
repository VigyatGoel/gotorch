...
// func main() {
// 	// Load CSV data
// 	dataLoader := data.NewDataLoader("examples/iris.csv", data.Classification, 32)
// 	err := dataLoader.Load()
// 	if err != nil {
...
// 		layer.NewLinear(numFeatures, 8),
// 		layer.NewReLU(),
// 		layer.NewLinear(8, 16),
// 		layer.NewReLU(),
// 		layer.NewDropout(0.3), // 30% dropout
// 		layer.NewLinear(16, numClasses),
// 		layer.NewSoftmax(),
// 	)
